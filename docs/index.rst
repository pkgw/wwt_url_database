wwt_url_database: checking that WorldWide Telescope URLs are live
=================================================================
...
survey data stored in the cloud. The ``wwt_url_database`` package is a utility
...
Work on ``wwt_url_database`` is funded through the American Astronomical
